...
from library_16_01_2014 import *
import osgeo.ogr,osgeo.osr,osgeo.gdal

## Parameters ##########################################################################
input_image = "F:\\Sensum_xp\\Izmir\\my_seg_opt\\pansharp.TIF" #original image
input_shape = "F:\\Sensum_xp\\Izmir\\my_seg_opt\\manual_polygons.shp" #reference polygon
path = "F:\\Sensum_xp\\Izmir\\my_seg_opt\\"

segmentation_name = 'Region_growing_integers'
nloops = 10
...
for j in range(1,len(Polygon_Files)+1):
    ...
    Shp2Rast(inshape,outfile,0,0,'conv',pixelWidth,pixelHeight)
