...
import numpy as np
from library_25_11_2013 import *
import time

### Parameters #########################################################################################
#input_image = 'C:\workspace\Sensum\Izmir\Applications\multiband_segmentation\\clipped_merged_new.tif'
input_image = "F:\\Sensum_xp\\Izmir\\building_extraction_2\\pansharp.TIF"
Folder_output = 'F:\\Sensum_xp\\Izmir\\building_extraction_2\\'
...
edison_otb(input_image,Folder_output+'Segmentation_edison.shp','vector',7,0,0,0)
end_time = time.time()
print '--- Time: ' + str(end_time-start_time)
