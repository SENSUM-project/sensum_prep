...
def reproject_shapefile(path,name_input,name_output,epsg_output,option):
    ...
    - nameo_output: name assigned to the output shapefile
...
def transform_utm_to_wgs84(easting, northing, zone):#http://monkut.webfactional.com/blog/archive/2012/5/2/understanding-raster-basic-gis-concepts-and-the-python-gdal-library/
...
def building_alignment(input_file):
    ...
    for i in range(0,len(angle)):
        ...
        r = np.sum(rot,axis=1)
        #print c
        x1_c = collections.Counter(c)
        x1_r = collections.Counter(r)
