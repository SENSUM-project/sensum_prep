...
def spectral_features((output_type,seg_data,input_data,start_i,end_i)):
    ...
    '''
    ###################################################################################################################
    Computes the spectral features: mean, standard deviation, maximum brightness, minimum brightness
    ...
    Output:
    A list is returned, content depends on the chosen output_type (mean, standard deviation, max brightness, min brightness)
    ###################################################################################################################
    '''
    #default
    if (output_type == ''):
